...
2. "destinos_sugeridos": Una lista de 3 destinos recomendados. Para cada destino incluye:
  - "nombre": nombre del destino con aeropuerto, no pongas el aeropuerto en el nombre, estricatmente el nombre del lugar y país.
  ...
  - "lugares_destacados": 2 lugares importantes con:
      - "nombre"
      - "descripcion"
      ...
      - "evento": Un evento relevante que ocurra durante las fechas indicadas por los usuarios. Debe haber al menos 1 evento por cada lugar destacado en cada destino sugerido. Para cada evento, incluye:
          - "nombre"
          - "descripcion"
